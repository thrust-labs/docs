...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Make beautiful web3 gaming hubs <br className='sm:block hidden'/>with Thrust Network</h1>
    <p className="subtitle">Simple, powerful and extendable</p>
    ...
    <div className="content-container">
      <Features>
        <Feature index={0} large centered id="docs-card" href="/docs/">
          ...
          <h3>Web3 Gaming Hubs of tomorrow's communities</h3>
        </Feature>
        <Feature index={1} centered className="card-with-border" href="/docs/guide/marketplace">
          <div className="h-full flex flex-col justify-between">
            <h3>Marketplace support</h3>
            <br/>
            <p className='text-left mb-8'>Thrust Network integrates with over 150 web3 marketplaces and pushes your listing to all of them.</p><br/>
            <div>
        ...
        <Feature index={2} id="highlighting-card" href="/docs/extensions-and-widgets">
          <h3>Extensions and widgets</h3>
          <p>Fully decentralised protocols can easily integrate their tech stack and make it accessable from within hubs</p>
        </Feature>
        <Feature index={3} href="/docs/guide/i18n">
          <h3>Customize with your branding</h3>
          <p>Make your users feel like at home</p>
        </Feature>
